...
#
# Assumes it will talk to a moondexd or MoonDEX-Qt running
# on localhost.
#
# Depends on jsonrpc
#
...
def determine_db_dir():
    """Return the default location of the MoonDEX data directory"""
    if platform.system() == "Darwin":
        return os.path.expanduser("~/Library/Application Support/MoonDEXCore/")
    elif platform.system() == "Windows":
        return os.path.join(os.environ['APPDATA'], "MoonDEXCore")
...
def connect_JSON(config):
    """Connect to a MoonDEX JSON-RPC server"""

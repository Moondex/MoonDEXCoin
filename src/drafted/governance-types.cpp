...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "MoonDEXNetwork") type = MoonDEXNetwork;
    if(strType == "MoonDEXNetworkVariable") type = MoonDEXNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == MoonDEXNetwork) s = "MoonDEXNetwork";
    if(type == MoonDEXNetworkVariable) s = "MoonDEXNetworkVariable";

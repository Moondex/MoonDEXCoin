 ...
 *
 *   // network
 *   CMoonDEXNetwork lvl, network-type, network-status, network-error, milestone-status*
...
// // root node
class CMoonDEXNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CMoonDEXNetwork(UniValue objIn)
    {
...
// // can be under: MoonDEXNetwork
// //   -- signature requirements : Key1(User)
// class CMoonDEXNetworkVariable : public CGovernanceObject
// {
// private:

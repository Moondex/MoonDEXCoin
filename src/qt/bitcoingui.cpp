    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("MoonDEX") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MoonDEX address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About MoonDEX"), this);
    aboutAction->setStatusTip(tr("Show information about MoonDEX"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MoonDEX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MoonDEX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MoonDEX addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the MoonDEX help message to get a list with possible MoonDEX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("MoonDEX client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MoonDEX network", "", count));
}
...
{
    QString strTitle = tr("MoonDEX"); // default title

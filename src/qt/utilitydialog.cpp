    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("MoonDEX") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About MoonDEX"));
...
All the MoonDEX in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 MDEX, 0.1 MDEX, 1 MDEX and 10 MDEX -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("MoonDEX is shutting down...") + "<br /><br />" +

...
This document provides guidelines for internationalization of the MoonDEX software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to MoonDEX network</numerusform>
            <numerusform>%n active connections to MoonDEX network</numerusform>
        </translation>
    </message>

...
Only requiring some minor changes is moondex.cpp.
...
Changes to moondex.cpp
----------------------
moondex.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
